...
barry_file_name = 'output/hubspotContactBarryPhillips.json'
barry_deal_file_name = 'output/hubspotDealsBarryPhillips.json'
...
jamie_file_name = 'output/hubspotContactJamieWickstein.json'
jamie_deal_file_name = 'output/hubspotDealsJamieWickstein.json'
...
with open('output/hubspotContactProperties.json', 'w') as file:
...
with open('output/hubspotContactJamieWicksteinWithProperties.json', 'w') as file:
...
# Output to a new file
with open('output/hubspotAllContacts.json', 'w') as file:
